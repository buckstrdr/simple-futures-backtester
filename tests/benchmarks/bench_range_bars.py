...
Run with: pytest tests/benchmarks/bench_range_bars.py -v
"""
...
def test_range_bars_1m_rows_performance() -> None:
    """Measure throughput for 1M rows of range bar generation."""
...
def test_range_bars_100k_rows() -> None:

...
Run with: pytest tests/benchmarks/bench_tick_bars.py -v
"""
...
def test_tick_bars_1m_rows_performance() -> None:
    """Measure throughput for 1M rows of tick bar generation."""
    ...
    assert len(result) == 100_000, f"Should generate exactly 100K bars (1M / 10)"


def test_tick_bars_100k_rows() -> None:
